    ...
    <PageWrapper>
      <section className="bg-background py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="max-w-2xl">
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-foreground tracking-tight text-balance">
              Full Implementation
            </h1>
            ...
            <div className="mt-8">
              <Button asChild className="rounded-full font-heading font-semibold px-7 h-12">
      ...
      <section className="bg-secondary py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-6 flex flex-col items-center">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground text-center mb-10">The Complete System</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {phases.map((p, i) => (
              <div key={i} className="bg-secondary rounded-2xl p-8 border border-border/50 flex flex-col">
                <span className="font-heading text-xs font-bold text-accent tracking-widest uppercase">{p.phase}</span>
      ...
      <section className="bg-secondary py-16 lg:py-20">
        <div className="mx-auto max-w-4xl px-6 text-center">
          <h2 className="font-heading text-2xl md:text-3xl font-bold text-foreground mb-8">Expected Outcomes</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-background rounded-xl p-5 border border-border/50">
                <p className="font-heading text-2xl font-bold text-accent">{item.metric}</p>
